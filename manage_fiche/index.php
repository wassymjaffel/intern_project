    ...
    <div class="row" style="width: 98%;margin: auto;">
        <div class="col-md-12 col-lg-12">
            ...
            <table id="ficheTable" class="table" style=" margin-top: 37px; ">
                ...
                <tbody>
                    <?php $fiche_service = new fiche_service($db);
            $list_fiche = $fiche_service->getAll();
            for ($i=0; $i < count($list_fiche); $i++) { 
            ?>
                    <tr>
                        <th scope="row"><?php echo $i; ?></th>
                        <td><?php print($list_fiche[$i]->getpatient()->getFirst_name().' '.$list_fiche[$i]->getpatient()->getLast_name()); ?>
                        </td>
                        <td><a href="./fiche.php?id=<?php echo $list_fiche[$i]->getId(); ?>"
                                class="btn btn-info">Afficher</a></td>
                        <td><a href="edit_fiche.php?id=<?php echo $list_fiche[$i]->getId(); ?>"
                                class="btn btn-primary">Modifier</a></td>
                        <td><a href="delete_fiche_action.php?id=<?php echo $list_fiche[$i]->getId(); ?>"
